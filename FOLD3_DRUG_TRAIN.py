...
sequence_files = {
    "train": "5fold/X_train_fold3.csv",
    "validation": "5fold/X_val_fold3.csv",
    "test": "5fold/X_test_fold3.csv"
}

labels_files = {
    "train": "5fold/y_train_drug_fold3.csv",
    "validation": "5fold/y_val_drug_fold3.csv",
    "test": "5fold/y_test_drug_fold3.csv"
}
...
metrics_path = os.path.join(output_dir, "results_drug_fold3.txt")

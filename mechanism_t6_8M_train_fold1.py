...
os.chdir('/work/08563/tac0225/ls6/plm')
print(os.getcwd())
...
sequence_files = {
    "train": "hmd-final/X_train_hmd_fold1.csv",
    "validation": "hmd-final/X_val_hmd_fold1.csv",
    "test": "hmd-final/X_test_hmd_fold1.csv"
}

labels_files = {
    "train": "hmd-final/y_train_mech_fold1.csv",
    "validation": "hmd-final/y_val_mech_fold1.csv",
    "test": "hmd-final/y_test_mech_fold1.csv"
}
...
model = AutoModelForSequenceClassification.from_pretrained("facebook/esm2_t6_8M_UR50D", num_labels=7)
 
# Trainer initialization
training_args = TrainingArguments(
    output_dir="./results_mech_t6_8M_fold1",
    num_train_epochs=10,
...
metrics_path = os.path.join(output_dir, "results_mech_t6_8M_fold1.txt")

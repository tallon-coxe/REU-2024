...
labels_files = {
    "train": "5fold/y_train_drug_fold1.csv",
    "validation": "5fold/y_val_drug_fold1.csv",
    "test": "5fold/y_test_drug_fold1.csv"
}
...
metrics_path = os.path.join(output_dir, "results_drug_fold1.txt")
